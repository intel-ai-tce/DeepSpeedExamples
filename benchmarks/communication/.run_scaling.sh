...
function nw_config()
{
    ...
    export CCL_WORKER_COUNT=$worker
...
function build_launch_args_fi_psm3(){
    ...
    margs="$margs --genv FI_PROVIDER_PATH=/home/ubuntu/.local/lib/python3.10/site-packages/oneccl_bindings_for_pytorch/lib/"  # Specify the location of the installed PSM3 provider, when use torch-ccl the version in torch-ccl enviroment will be used
...
num_iter=10
warmup=2
ONECCL_NUM_WORKERS=1  ## You could tune the worker number for your workload
